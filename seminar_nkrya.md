...
# 1.3 Почему количество документов меньше количества вхождений? Ответ: в одном документе слово может встречаться несколько раз
```
### 2. IPM
...
```
# 3.1 Ответ: 15 351 с кавычками, 8 892 без кавычек
```
...
```
# 4.1 Самая последняя по алфавитному порядку словоформа: Явился
```
